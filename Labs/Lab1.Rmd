...
You may work on this in groups of two. When finished, knit to PDF and submit to Gradescope as a group. For instructions on how to submit as a group see the following: https://help.gradescope.com/article/m5qz2xsnjy-student-add-group-members
...
6. Manipulate the `teen_data` so that you can focus in on the ninth graders. Save the data set with only ninth grade data as `ninth_graders`.
...
13. Create two histograms for the weights of ninth graders, one with $3$ breaks and the other with $30$ breaks.  

```{r}
#insert code here
```

14. Which histogram is better for displaying the weight data? Justify your answer with at least two reasons.
...
17. Make a single graph that has one boxplot for each grade of the yrbss data.
