...
The Central Limit Theorem says that as the sample size $n$ increases, the sampling distribution of the difference of two sample means will approach a t-distribution with degrees of freedom equal to the smaller of $n_1-1$ or $n_2-1$:
...
3. An inventor has developed a new, energy-efficient engine. He claims that the engine will run continuously for more than $5$ hours ($300$ minutes) on a single gallon of regular gasoline. From his stock of engines, the inventor selects a simple random sample of $50$ engines for testing. The engines run for an average of $305$ minutes. The true standard deviation $\sigma$ is $30$ minutes. Set up a hypothesis test and make a conclusion with a $5 \%$ significance level. Include a drawing of the sampling distribution with the center and sample statistic both labeled. Shade the area represented by the $p$-value.
...
8. A Kaiser Family Foundation poll for US adults in 2019 found that $79 \%$ of Democrats, $55 \%$ of Independents, and $24 \%$ of Republicans supported a generic “National Health Plan”. There were $347$ Democrats, $298$ Republicans, and $617$ Independents surveyed. Conduct a hypothesis test to determine if the data provide strong evidence that the proportion of Democrats who support a national health plan is different than that of Independents.
...
9. Suppose we do a random sample of $20$ values from a population that is normally distributed with population standard deviation $6$. We want to perform a hypothesis test using a significance level $\alpha=.1$. If we use the following hypotheses:
